...
echo "# KernelSU " >> ./arch/arm64/configs/gki_defconfig
echo "###" >> ./arch/arm64/configs/gki_defconfig
echo "CONFIG_KSU=m" >> ./arch/arm64/configs/gki_defconfig
echo "CONFIG_KSU_DEBUG=y" >> ./arch/arm64/configs/gki_defconfig
echo "CONFIG_KSU_ALLOWLIST_WORKAROUND=y" >> ./arch/arm64/configs/gki_defconfig
...
echo "# end of KernelSU - SUSFS" >> ./arch/arm64/configs/gki_defconfig
echo "# end of KernelSU" >> ./arch/arm64/configs/gki_defconfig
echo "# end of Device Drivers" >> ./arch/arm64/configs/gki_defconfig
